    ...
    try {
      ...
      try {
        const { data: userData } = await supabase
          .from('usuarios')
          .select('rol, equipo, nombre, supervisor_id')
          .eq('email', email)
          .single()
        if (userData) {
          rol = userData.rol || 'asesor'
          localStorage.setItem('oratioo_session', JSON.stringify({
        ...
        <div className="relative w-full max-w-md">
          <div className="bg-[#3a0e50]/80 backdrop-blur-xl rounded-2xl p-10 border border-[#5d1a7a] shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-[#11ddde] text-sm mt-3 tracking-wide">Panel de gestion</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label className="block text-xs text-[#11ddde] font-medium mb-1.5 uppercase tracking-wider">Contrasena</label>
